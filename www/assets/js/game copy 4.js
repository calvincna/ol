...
Enemy = function (game, rotateSpeed) {
    ...
    var randomPosX = game.rnd.between(50, 350);
    var randomPosY = game.rnd.between(50, 600);
...
var Game = {
    ...
    create : function() {
		...
		areaTxt = game.add.bitmapText(55, 20, 'carrier_command', "100%", 15);
		areaTxt2 = game.add.bitmapText(325, 20, 'carrier_command', "v2", 15);
